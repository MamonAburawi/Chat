package com.info.chat.screens.different_user_profile
...
import com.info.chat.screens.main_activity.SharedViewModel
import com.info.chat.screens.profile.FriendsAdapter
import com.google.gson.Gson
import com.info.chat.R
import com.info.chat.databinding.DifferentUserProfileFragmentBinding
...
class DifferentUserProfileFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.different_user_profile_fragment, container, false)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProviders.of(this).get(DifferentUserProfileFragmentViewModel::class.java)
