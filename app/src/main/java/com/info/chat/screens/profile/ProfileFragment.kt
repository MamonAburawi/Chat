package com.info.chat.screens.profile
...
import com.info.chat.databinding.ProfileFragmentBinding
...
class ProfileFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        binding.placeInfoCard.cameraButton.setOnClickListener {
            openCamera()
        }
        binding.placeInfoCard.galleryButton.setOnClickListener {
            selectFromGallery()
        }
